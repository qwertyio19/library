    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(help_text='Формат: +996XXXXXXXXX', max_length=13, unique=True, validators=[apps.main.models.User.validate_phone_number], verbose_name='Номер телефона')),
